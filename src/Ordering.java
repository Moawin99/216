...
public class Ordering {
    ...
    static class XLocationShapeComparator implements Comparator<TwoDShape> {
        ...
        public int compare(TwoDShape o1, TwoDShape o2) {
            // TODO
            if(o1.getPosition().get(0).coordinates()[0] < o2.getPosition().get(0).coordinates()[0]){
                return -1;
            }
            else if(o1.getPosition().get(0).coordinates()[0] > o2.getPosition().get(0).coordinates()[0]){
                return 1;
            }
            return 0;
        }
